...
public class LoginSendDataModel {
   private int social_primary,social_type;
   private String username,full_name,avatar_url;

    public LoginSendDataModel() {
    }

    public LoginSendDataModel(int social_primary, int social_type, String username, String full_name, String avatar_url) {
